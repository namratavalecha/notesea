...
from .views import home_view, signup_view, activate, activation_sent_view, NoteList, NewNoteView, change_pinned, NoteDetail, detail_view, edit_view
...
urlpatterns = [
	...
	re_path(r'^delete/(?P<id>\d+)/$', NoteDetail.as_view(), name="delete-note"),
